...
<body>
	...
	<form class="was-validated" name="form" method="POST"
		...
		<div class="form-group row">
			<label for="have_pets" class="col-sm-2 col-form-label">반려동물
				유무</label>
			<div class="col-sm-10">
				<input type="text" readonly class="form-control-plaintext"
		...
		<label for="living_conditions" class="form-label">거주 환경</label>
		...
		<div class="mb-3">
			<label for="content" class="form-label">나의 조건</label>
		...
		<div class="mb-3">
			...
			&nbsp; <input type="button" value="동물들 다시보기"
