	...
	<div id="apply">
		...
		<div id="info">
			<div class="mb-3">
				...
				<div class="col-sm-10">
					<input type="text" readonly class="read_only_text" id="userName"
						value="${apply.user_name}">
				</div>
			</div>
			<br>
			...
			<div class="mb-3">
				...
				<div class="col-sm-10">
					<input type="text" readonly class="read_only_text"
						id="select_animal"
						value="[${apply.animal_type}] > ${apply.species}">
				</div>
			</div>
			<br>
			...
			<div class="mb-3">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control-plaintext" name="have_pets"
